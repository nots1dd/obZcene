...
OBZ_INTERNAL Vec3f     __OBZ_barycentric_persp(Vec3f a, Vec3f b, Vec3f c, int px, int py);
OBZ_INTERNAL Vec2f     __OBZ_interp_uv_persp(Vec2f uv0, Vec2f uv1, Vec2f uv2, float iz0, float iz1,
                                             float iz2, float w0, float w1, float w2);
